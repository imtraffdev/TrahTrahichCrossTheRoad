    ...
    static func missions() -> [TTRDailyMission] {
        ...
        return [
            TTRDailyMission(
                ...
                kind: .steps,
                title: "Lane Sprint",
                subtitle: "Move through the city using GO and the arrows.",
                icon: "figure.run",
                goal: stepGoal,
                reward: 20 + seed % 8,
            ...
            TTRDailyMission(
                ...
                subtitle: "Reach the next safe hub without a crash.",
                icon: "flag.checkered",
                goal: crossingGoal,
                reward: 34 + seed % 12,
            ...
            TTRDailyMission(
                ...
                kind: .miniGames,
                title: "Street Events",
                subtitle: "Restore hubs using signal, pressure or drain devices.",
                icon: "sparkles",
                goal: miniGameGoal,
                reward: 38 + seed % 12,
